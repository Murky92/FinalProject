...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isShopPage) {
        ...
        // Start observing the shop-content element for display changes
        const shopContent = document.getElementById('shop-content');
        observer.observe(shopContent, { attributes: true, attributeFilter: ['style'] });
    } else {
        // For non-shop pages, add the footer immediately
        createFooter();
    }
